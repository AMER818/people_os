        ...
        <div className="space-y-5 animate-in fade-in duration-700">
            <div className="bg-surface rounded-2xl border border-border p-5 shadow-2xl">
                <div className="flex items-center gap-4 mb-5">
                    ...
                    <div>
                        <h3 className="text-lg font-black text-text-primary uppercase tracking-tight">Communications</h3>
                        <p className="text-text-muted text-xs font-bold antialiased">Configure email and mobile gateway nodes.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <h4 className="text-[0.6rem] font-black text-text-muted uppercase tracking-[0.2em] flex items-center gap-2">
                            <Mail size={12} className="text-primary" /> Email Server Settings
                        </h4>
                        <div className="space-y-3">
                            ...
                            />
                            <Button variant="secondary" className="w-full py-2 h-9 font-black uppercase tracking-widest text-[0.6rem]" aria-label="Test Email Connectivity">
                                Test Email
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <h4 className="text-[0.6rem] font-black text-text-muted uppercase tracking-[0.2em] flex items-center gap-2">
                            <Smartphone size={12} className="text-primary" /> SMS Provider Settings
                        </h4>
                        <div className="space-y-3">
                            <div className="space-y-1.5">
                                <label className="text-[0.6rem] font-black text-text-muted uppercase tracking-widest ml-1">SMS Service</label>
                                <select
                ...
                <div className="mt-8">
                    <Button onClick={handleSave} isLoading={isSaving} className="w-full py-4 h-10 font-black uppercase tracking-[0.2em] text-[0.65rem]" aria-label="Save all communication node settings">
