      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[0.625rem] font-black text-text-muted uppercase tracking-[0.25em] mt-2">
            Historical Disciplinary Node Logs
          </p>
        </div>
        <Button
          variant="danger"
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-muted-bg text-[0.625rem] font-black uppercase text-text-muted tracking-[0.25em]">
              <th className="px-12 py-8">Temporal Mark</th>
              <th className="px-10 py-8">Incident Protocol</th>
              <th className="px-10 py-8">Resolution</th>
              ...
              <tr key={action.id} className="hover:bg-danger-soft/20 transition-all">
                <td className="px-12 py-6">
                  <input
                    ...
                    className="bg-transparent border-none font-bold text-text-primary outline-none"
                  />
                </td>
