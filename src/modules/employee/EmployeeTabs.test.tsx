...
describe('Employee Tabs', () => {
    ...
    describe('DisciplineTab', () => {
        it('renders correctly and adds a log', () => {
            ...
            expect(mockUpdateField).toHaveBeenCalledWith('discipline', expect.arrayContaining([
        ...
        it('renders existing logs', () => {
            const empWithDiscipline = {
                ...mockEmployee,
                discipline: [{ id: '1', date: '2023-01-01', description: 'Test Incident', outcome: 'Verbal Warning' }]
            };
        ...
        it('updates and removes a log', () => {
            const emp = { ...mockEmployee, discipline: [{ id: '1', date: '', description: '', outcome: '' }] };
            ...
            expect(mockUpdateField).toHaveBeenCalledWith('discipline', expect.arrayContaining([expect.objectContaining({ description: 'Test' })]));
    ...
    describe('FamilyTab', () => {
        it('renders correctly and adds a member', () => {
            ...
            expect(mockUpdateField).toHaveBeenCalledWith('family', expect.arrayContaining([
                expect.objectContaining({ name: '', relationship: 'Child' })
            ]));
        });
        ...
        it('updates and removes a member', async () => {
            ...
            await waitFor(() => {
                expect(mockUpdateField).toHaveBeenCalledWith('family', expect.arrayContaining([expect.objectContaining({ relationship: 'Spouse' })]));
            });
    ...
    describe('EducationTab', () => {
        it('renders correctly and adds education', () => {
            ...
            expect(mockUpdateField).toHaveBeenCalledWith('education', expect.arrayContaining([
                expect.objectContaining({ degree: '', institute: '' })
            ]));
        });

        it('updates and removes education', () => {
            const emp = { ...mockEmployee, education: [{ degree: '', institute: '', year: '', gradeGpa: '', marksObtained: 0, totalMarks: 0 }] };
            ...
            expect(mockUpdateField).toHaveBeenCalledWith('education', expect.arrayContaining([expect.objectContaining({ degree: 'BSCS' })]));
    ...
    describe('ExperienceTab', () => {
        it('renders correctly and adds experience', () => {
            ...
            expect(mockUpdateField).toHaveBeenCalledWith('experience', expect.arrayContaining([
                expect.objectContaining({ orgName: '', designation: '' })
            ]));
        });

        it('updates and removes experience', () => {
            const emp = { ...mockEmployee, experience: [{ orgName: '', from: '', to: '', designation: '', salary: 0, remarks: '' }] };
            ...
            expect(mockUpdateField).toHaveBeenCalledWith('experience', expect.arrayContaining([expect.objectContaining({ orgName: 'Tech Corp' })]));
